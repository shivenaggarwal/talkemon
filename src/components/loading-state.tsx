  ...
  return (
    <div className="py-4 px-8 flex flex-1 items-center justify-center">
      <div className="flex flex-col items-center justify-center gap-y-6 bg-gradient-to-br from-amber-50/50 to-orange-50/50 border-2 border-amber-200 rounded-xl p-10 shadow-lg backdrop-blur-sm">
        <div className="p-3 rounded-full bg-gradient-to-br from-amber-100/50 to-orange-100/50 border-2 border-amber-200 shadow-md ring-2 ring-amber-200/30">
          <Loader2Icon className="size-6 animate-spin text-amber-600" />
        </div>
