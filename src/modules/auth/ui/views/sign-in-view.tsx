  ...
  return (
    <div className="flex flex-col gap-6">
        ...
        <CardContent className="grid p-0 md:grid-cols-2">
          <Form {...form}>
            <form
              ...
              className="p-8 md:p-12 bg-gradient-to-br from-cream-100 to-orange-50"
            >
              <div className="flex flex-col gap-8">
                ...
                <div className="grid gap-4">
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel className="text-amber-800 font-medium text-sm">
                          Email
                        </FormLabel>
                        <FormControl>
                          <Input
                ...
                <div className="text-center text-sm text-amber-700">
                  ...
                  <Link
                    href="/sign-up"
                    className="text-amber-600 underline underline-offset-4 hover:text-amber-800 transition-colors duration-300 font-medium"
                  >
                    Sign Up
                  </Link>
                </div>
          ...
          <div className="bg-gradient-to-br from-amber-400 via-orange-400 to-red-400 relative hidden md:flex flex-col gap-y-6 items-center justify-center p-8">
            <div className="bg-white/20 backdrop-blur-sm rounded-full p-6 shadow-2xl">
              <img
                src="/logo.svg"
                alt="Image"
                className="h-[92px] w-[92px] filter drop-shadow-lg"
              />
            </div>
      ...
      <div className="text-amber-700/80 text-center text-xs text-balance max-w-md mx-auto">
        ...
        <Link
          href="/terms"
          className="text-amber-600 underline underline-offset-4 hover:text-amber-800 transition-colors duration-300"
        >
          Terms of Service
        </Link>{" "}
        and{" "}
