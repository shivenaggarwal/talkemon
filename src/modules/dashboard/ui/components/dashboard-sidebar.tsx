  ...
  return (
    <Sidebar className="bg-gradient-to-br from-amber-100/80 to-orange-100/80 backdrop-blur-sm border-0 shadow-2xl">
      <SidebarHeader className="flex justify-center items-center w-full text-amber-900 bg-gradient-to-br from-cream-100 to-orange-50 border-b-2 border-amber-200 p-0">
        <Link
          href="/"
          className="flex items-center gap-3 py-6 hover:scale-[1.02] transition-all duration-300 max-w-fit"
        >
          <Image
            src="/logo.svg"
            height={48}
          ...
          />
          <p className="text-3xl font-bold font-serif tracking-wide text-amber-900 drop-shadow-sm">
            Talkemon
          </p>
        </Link>
      </SidebarHeader>
                ...
                <SidebarMenuItem key={item.href}>
                  <SidebarMenuButton
                    ...
                    className={cn(
                      ...
                      pathName === item.href &&
                        "bg-gradient-to-r from-amber-400 to-orange-400 border-amber-400 shadow-xl scale-[1.02] text-white font-semibold hover:from-amber-500 hover:to-orange-500"
                    )}
